    ...
    <body class="subpage">
        ...
        <footer id="footer">
            <div class="inner">
                <h2>Detail Leave</h2>
                <?php
                $userid = $_GET["detail_leave"]; //รับค่า GET รหัสของพนักงานที่ส่งมา
                include './connect.php';
                ...
                <div align="center">
                    ...
                    <div class="6u 12u$(small)">
                        <ul class="actions fit">
                            <li><a class="button fit" href="HR_VLeave.php">Back</a></li>

<?php if ($result[1] == '7') { ?>
                                
                                <li><a class="button fit" href="cancleLeaveByHR.php?cancle_leave=<?php echo $result[0]; ?>" onclick="return confirm(' Are you sure want cancel ?')" >Cancel Leave</a></li>
                            </ul>
                        </div> 
